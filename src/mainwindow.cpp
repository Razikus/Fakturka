...
void MainWindow::on_actionhelp_triggered()
{
    ...
    const char* str = "%yyyy% - bieżący rok \n"
                      "%MM% - bieżący miesiąc \n"
                      "%dd% - bieżącym dzień \n"
                      "%NR% - numer faktury w bieżącym miesiącu \n"
                      "%NRFAKTURY% - sformatowany numer faktury \n"
                      "%LOGO% - link do loga \n"
                      "%DATAWYSTAWIENIA% - data wystawienia faktury \n"
                      "%DATASPRZEDAZY% - data sprzedaży faktury \n"
                      "%TERMINPLATNOSCI% - termin płatności \n"
                      "%TYPPLATNOSCI% - typ płatności \n"
                      "%SPRZEDAJACYNAZWA% - nazwa sprzedającego \n"
                      "%SPRZEDAJACYULICA% - ulica sprzedającego \n"
                      "%SPRZEDAJACYKODPOCZTOWYMIASTO% - kod pocztowy i miasto sprzedającego \n"
                      "%SPRZEDAJACYNIP% - nip sprzedającego \n"
                      "%SPRZEDAJACYBANK% - bank sprzedającego \n"
                      "%SPRZEDAJACYKONTO% - numer konta sprzedającego \n"
                      "%KUPUJACYNAZWA% - nazwa kupującego \n"
                      "%KUPUJACYULICA% - ulica kupującego \n"
                      "%KUPUJACYKODPOCZTOWYMIATO% - kod pocztowy i mistao kupującego \n"
                      "%KUPUJACYNIP% - nip kupującego \n"
                      "%TOWARWARTOSCNETTO% - wartość netto całego towaru \n"
                      "%TOWARWARTOSCVAT% - wartość vat całego towaru \n"
                      "%TOWARWARTOSCBRUTTO% - wartość brutto całego towaru \n"
                      "%TOWARWARTOSCNETTOPORABACIE% - wartość netto po rabacie całego towaru \n"
                      "%TOWAR% - tabela przedstawiająca towar. Generowany jest tag <table> \n";
